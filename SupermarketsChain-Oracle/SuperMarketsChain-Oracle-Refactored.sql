...
BEGIN
  INSERT ALL
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (20, 'Beer “Zagorka”', 100, 0.86, 'AlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (30, 'Vodka “Targovishte”', 100, 7.56, 'AlcoholDrinks')          
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (20, 'Beer “Beck’s”', 100, 1.03, 'AlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (10, 'Chocolate “Milka”', 200, 2.80, 'Confectionery')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (40, 'Coca-Cola 2l', 100, 2.50, 'NonAlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (50, 'Jim Beam', 100, 20, 'AlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (70, 'Kamenitza', 100, 1.25, 'AlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (10, 'Nesquik 200g', 300, 4.15, 'NonAlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (10, 'Kit-Kat 90g', 300, 1.00, 'Confectionery')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (10, 'Nescafe 250g', 300, 9.50, 'NonAlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
    ...
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (180, 'Aroma Vital Exfoliating soap 100g', 200, 0.99, 'BodyCare')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (170, 'Devin Mineral Water 10l', 100, 3.99, 'NonAlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (170, 'Devin Mineral Water 1.5l', 100, 0.85, 'NonAlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
    ...
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (190, 'Head ' || chr(38) || ' Shoulders', 200, 5.35, 'BodyCare')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (140, 'Happy Day 100% Orange 1l', 200, 2.30, 'NonAlcoholDrinks')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (10, 'Heinz Tomato Ketchup', 200, 4.80, 'Food')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (200, 'NIVEA honey ' || chr(38) || ' oil soap', 200, 0.90, 'BodyCare')
    INTO PRODUCTS (VENDOR_ID, PRODUCT_NAME, MEASURE_ID, PRICE, PRODUCT_TYPE) 
          VALUES  (180, 'Natural Elements Red Fruits soap 100g', 200, 0.99, 'BodyCare')            
    SELECT * FROM dual  
    COMMIT;
EXCEPTION
  WHEN DUP_VAL_ON_INDEX
